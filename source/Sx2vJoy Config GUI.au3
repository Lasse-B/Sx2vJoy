...
Dim $start[1][2] = [[412, 165]]
_GUICtrlCreateGroupEx("Assign Buttons", $start[0][0], $start[0][1], 315, 50, 0xA9A9A9)
...
$aButtonIDs[1] = GUICtrlCreateCombo("Choose Your Device...", $start[0][0] + 5, $start[0][1] + 20, 290, 10, $CBS_DROPDOWNLIST)
$controlcontent = ""
...
Dim $start[1][2] = [[412, 8]]
_GUICtrlCreateGroupEx("Assign Axes ", $start[0][0], $start[0][1], 315, 132, 0xA9A9A9)
...
GUICtrlCreateLabel("3DC Axis", $start[0][0] + 5, $start[0][1] + 55, 50, 15)
GUICtrlCreateLabel("controls", $start[0][0] + 8, $start[0][1] + 80, 120, 15)
GUICtrlCreateLabel("vJoy Axis", $start[0][0] + 5, $start[0][1] + 106, 50, 15)
$xcorr = 0
Dim $aAxes[0]
...
For $i = 0 To 5
	...
	If $i > 2 Then $xcorr = -3
	GUICtrlCreateLabel($aLabelsvJ[$i], $i * 40 + $start[0][0] + 75 + $xcorr, $start[0][1] + 55, 15, 15)
	GUICtrlCreateLabel("¯", $i * 40 + $start[0][0] + 75, $start[0][1] + 80, 15, 15)
	GUICtrlSetFont(-1, 9, 400, "", "Symbol", 4)
	$aAxesIDs[$i + 1] = GUICtrlCreateCombo("", $i * 40 + $start[0][0] + 60, $start[0][1] + 103, 37, 10, $CBS_DROPDOWNLIST)
	GUICtrlSetData(-1, "x|y|z|Rx|Ry|Rz", $aAxes[$i])
Next

Dim $gridPos[1][2] = [[0, 0]]
_GUICtrlCreateGroupEx("Input ", $gridPos[0][0] * ($spacebetween_x + $width) + $spacefromborder_x, $gridPos[0][1] * ($spacebetween_y + $height) + $spacefromborder_y, 280, 180, 0xA9A9A9)
...
Dim $gridPos[1][2] = [[0, 2]]
_GUICtrlCreateGroupEx("Output Sensitivity", $gridPos[0][0] * ($spacebetween_x + $width) + $spacefromborder_x, $gridPos[0][1] * ($spacebetween_y + $height) + $spacefromborder_y, 720, 305, 0xA9A9A9)
...
Func _newProfile()
	...
	$split = StringSplit($aArray[0], @LF)
	_ArrayInsert($split, 1, "executable = ", 0)
